    ...
    <?php foreach ($barang as $brg) : ?>
      ...
      <div class="card ml-3 mb-3 film-card mr-auto ml-auto" style="width: 16rem;">
        ...
        <div class="card-body" style="background: linear-gradient(to right, #000000, #333333); color: white;">
          ...
          <br>
          <span class="badge badge-pill badge-light-purple mb-3">Rp<?php echo number_format($brg->harga, 0, ',', '.') ?></span><br>
          <?php echo anchor('dashboard/tambah_ke_keranjang/' . $brg->id_brg, '<div class="btn btn-sm btn-primary add-to-cart">Beli Tiket</div>') ?>
